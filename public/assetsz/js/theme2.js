(function($) {
    ...
    var ST = {
        ...
        cartDrawer: function() {
            ...
            function miniCart() {
                $cartDrawer.removeClass("invisible").addClass("active visible");
                $bgShop.removeClass("opacity-0 invisible").addClass("opacity-50 visible");
            }
        },
        wishList: function() {
                    ...
                    var newReviewDetail = `
                        <div class="product-review-detail">
                            <div class="product-reviewer-info d-flex flex-wrap align-items-center">
                                ...
                                <h6 class="product-reviewer-name width-calc-48 font-18 psl-15">${reviewName}</h6>
                            </div>
    ...
    ST.categorySlider = {
        init: function() {
            function adjustArrowPosition() {
                var $sliderHeight = $(".cat-wrap .swiper-slide").height(),
                    $buttonHeight = $(".cat-wrap .swiper-buttons button").outerHeight(),
    ...
    ST.hotSpot = {
        init: function() {
            $("button.hot-spot-trigger").on("click", function() {
                $(".hot-spot").each(function() {
                    var $hotSpotContent = $(this).find(".hot-spot-content");
                    if ($(this).find(".hot-spot-trigger")[0] === event.currentTarget) {
                        $hotSpotContent.fadeIn();
                    } else {
                        $hotSpotContent.fadeOut();
                    }
                });
            });
            $("button.hot-spot-close-btn").on("click", function () {
                $(this).closest(".hot-spot-content").fadeOut();
            });
        }
    };
    ST.tabSlider = {
