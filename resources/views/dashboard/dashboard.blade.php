    ...
    <div class="row">
        ...
        <div class="col-6 col-md-6 col-lg-3">
            <div class="card project-cards">
                <div class="card-body d-flex justify-content-between">
                    <div>
                        <h6>Mahasiswa<span class="badge text-success"></span></h6>

                        <div class="d-flex align-items-center gap-2 mt-2">
                            <h4 class=" text-success f-w-600 counting" data-count='499'>222</h4>
                        </div>
                    </div>
        ...
        <div class="col-6 col-md-6 col-lg-3">
            <div class="card project-cards">
                <div class="card-body d-flex justify-content-between">
                    <div>
                        <h6>Dosen<span class="badge text-warning"></span></h6>

                        <div class="d-flex align-items-center gap-2 mt-2">
                            <h4 class=" text-warning f-w-600 counting" data-count='159'> 154</h4>
                        </div>
                    </div>
        ...
        <div class="col-6 col-md-6 col-lg-3">
            <div class="card project-cards">
                <div class="card-body d-flex justify-content-between">
                    <div>
                        <h6>Jurusan<span class="badge text-danger"></span></h6>

                        <div class="d-flex align-items-center gap-2 mt-2">
                            <h4 class=" text-danger f-w-600 counting" data-count='220'>200</h4>
                        </div>
                    </div>
        ...
        <div class="col-6 col-md-6 col-lg-3">
            <div class="card project-cards">
                <div class="card-body d-flex justify-content-between">
                    <div>
                        <h6 class="text-secondary">Ruangan<span class="badge text-success"></span></h6>

                        <div class="d-flex align-items-center gap-2 mt-2">
                            <h4 class=" text-success f-w-600 counting inline" data-count='199'>120</h4>
                        </div>
                    </div>
